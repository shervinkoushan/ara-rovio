#!/usr/bin/env python2
"""
https://gist.github.com/cedrusx/da24308e1824a6fabb0aa9f6ed7042b0
...
def main():
    ...
    i=0
    for file in files:
        outfile = file.rstrip('.bag') + '-unite-imu.bag'
        ...
        with rosbag.Bag(file) as inbag:
                ...
                for topic,msg,t in inbag.read_messages():
                    if topic=="/d455/accel/sample":
                        d400_accer.append(msg)
                        d400_accer_t.append(t)
                    if topic=="/d455/gyro/sample":
                        d400_gyr.append(msg)
                        d400_gyr_t.append(t)
                    outbag.write(topic, msg, t)
        imu0_topic="/d455/imu0"
        imu0=[]
        imu0_t=[]
